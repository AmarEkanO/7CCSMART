...
What makes Tor so popular as compared to other networks is that it was designed with the intention that its users could access the clear Internet while still being anonymous. Other networks such as I2P do not natively support clear Internet access. Tor was designed to be a low latency network so that existing time sensitive internet applications could be compatible without having to modify these applications. Remailer technology such as Mixmaster and Mixminion are high latency networks and are unsuitable for applications such as web browsing, internet chat or remote administration.

In 2011, The Tor Project received the 2010 Award for Projects of Social Benefit form the Free Software Foundation. The organization was quoted  
\begin{displayquote}
