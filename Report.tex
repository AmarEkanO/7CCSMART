...
Section \ref{comparison} does a comparative study of other popular anonymity networks with Tor. Section \ref{openissues} discusses the open issues with the Tor network and encourages the reader to take up some of these challenges.
